...
namespace AplicacionWeb.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Permiso,NombrePermiso,Descripcion")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Permiso,NombrePermiso,Descripcion")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
